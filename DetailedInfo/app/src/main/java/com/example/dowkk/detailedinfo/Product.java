...
//  private @ServerTimestamp Date timestamp; //에러이유 모르겠음
    ...
    public String toString() {
        return "Product [productCode=" + productCode + ", productName=" + productName + ", productImage=" + productImage
                + ", productDetailUrl=" + productDetailUrl + " seller=" + seller
    ...
    public String getBasicImage() {        return basicImage;    }

    public void setBasicImage(String basicImage) {        this.basicImage = basicImage;    }

    public String getAddImage1() {        return addImage1;    }

    public void setAddImage1(String addImage1) {        this.addImage1 = addImage1;    }

    public String getAddImage2() {        return addImage2;    }

    public void setAddImage2(String addImage2) {        this.addImage2 = addImage2;    }

    public String getAddImage3() {        return addImage3;    }

    public void setAddImage3(String addImage3) {        this.addImage3 = addImage3;    }

    public String getImageL300() {        return imageL300;    }

    public void setImageL300(String imageL300) {        this.imageL300 = imageL300;    }
    ...
    public String getShipFee() {        return shipFee;    }

    public void setShipFee(String shipFee) {        this.shipFee = shipFee;    }

    public String getSellSatisfaction() {        return sellSatisfaction;    }

    public void setSellSatisfaction(String sellSatisfaction) {        this.sellSatisfaction = sellSatisfaction;    }

    public String getSellGrade() {        return sellGrade;    }

    public void setSellGrade(String sellGrade) {        this.sellGrade = sellGrade;    }
